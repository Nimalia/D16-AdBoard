...
SECRET_KEY = 'django-insecure-x8#mn3umc#hijin#t^g8z8*(%&2o^k+1#aagn57n3$y7_dgsn#'
...
EMAIL_PORT = 465
EMAIL_HOST_USER = "_______@yandex.ru"
EMAIL_HOST_PASSWORD = "_________"
EMAIL_USE_TLS = False
EMAIL_USE_SSL = True

DEFAULT_FROM_EMAIL = "_________@yandex.ru"
SERVER_EMAIL = "___________@yandex.ru"
